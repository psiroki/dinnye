...
#define INT_PAIR(a, b) { static_cast<int32_t>(a), static_cast<int32_t>(b), }
  const int32_t gameControllerMapping[][2] = {
    ...
    INT_PAIR(SDL_CONTROLLER_BUTTON_A, Control::EAST),
    INT_PAIR(SDL_CONTROLLER_BUTTON_B, Control::SOUTH),
    INT_PAIR(SDL_CONTROLLER_BUTTON_X, Control::NORTH),
    INT_PAIR(SDL_CONTROLLER_BUTTON_Y, Control::WEST),
    INT_PAIR(SDL_CONTROLLER_BUTTON_BACK, Control::SELECT),
    INT_PAIR(SDL_CONTROLLER_BUTTON_GUIDE, Control::UNMAPPED),
